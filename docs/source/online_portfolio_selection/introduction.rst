...
.. code-block::
    ...
    from portfoliolab.online_portfolio_selection.benchmarks import *

    # Import all momentum strategies.
    from portfoliolab.online_portfolio_selection.momentum import *

    # Import all mean reversion strategies.
    from portfoliolab.online_portfolio_selection.mean_reversion import *

    # Import all pattern matching strategies.
    from portfoliolab.online_portfolio_selection.pattern_matching import *

    # Import a specific buy and hold strategy.
    from portfoliolab.online_portfolio_selection import BAH

    # Import buy and hold and universal portfolio.
    from portfoliolab.online_portfolio_selection import BAH, UP
...
.. automodule:: portfoliolab.online_portfolio_selection.base
