.. _estimators-returns_estimation:
...
returns of a portfolio/asset. PortfolioLab's :py:mod:`ReturnsEstimators` class provides functions to estimate mean asset returns.
...
.. automodule:: portfoliolab.estimators.returns_estimators
