.. _estimators-theory_implied_correlation:
...
.. tip::
    ...
    * The algorithm for de-noising the correlation and the covariance matrix is implemented in the RiskEstimators class of the portfoliolab package.
...
.. automodule:: portfoliolab.estimators.tic
