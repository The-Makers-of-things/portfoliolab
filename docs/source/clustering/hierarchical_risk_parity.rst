.. _clustering-hierarchical_risk_parity:
...
.. image:: clustering_images/seriation.png
...
.. automodule:: portfoliolab.clustering.hrp
...
* `How to use portfoliolab's HierarchicalRiskParity class`_

.. _How to use portfoliolab's HierarchicalRiskParity class: https://github.com/Hudson-and-Thames-Clients/research/blob/master/Portfolio%20Optimisation%20Tutorials/Hierarchical%20Risk%20Parity%20(HRP)/HRP%20Notebook.ipynb