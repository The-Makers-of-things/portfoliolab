.. _clustering-hierarchical_equal_risk_contribution:
...
.. image:: clustering_images/dendrogram.png
...
.. image:: clustering_images/gap.png
...
.. image:: clustering_images/bisection.png
...
.. note::
    ...
    better weights. The HERC method in portfoliolab provides the following risk metrics:
...
.. automodule:: portfoliolab.clustering.herc
...
.. tip::
    ...
    The following linkage methods are supported by the HERC class in portfoliolab. (The following is taken directly from and we highly
    recommend you read):
...
.. image:: clustering_images/dendrogram_herc.png
...
* `How to use portfoliolab's HierarchicalEqualRiskContribution class`_

.. _How to use portfoliolab's HierarchicalEqualRiskContribution class: https://github.com/Hudson-and-Thames-Clients/research/blob/master/Portfolio%20Optimisation%20Tutorials/Hierarchical%20Equal%20Risk%20Contribution%20(HERC)/HERC%20Tutorial%20Notebook.ipynb