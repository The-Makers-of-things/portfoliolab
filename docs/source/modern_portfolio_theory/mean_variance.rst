.. _modern_portfolio_theory-mean_variance:
...
PortfolioLab's :py:mod:`MeanVarianceOptimisation` class provide some common portfolio optimization problems out-of-the-box. In this section we go over a quick overview of
these:
...
.. warning::
    ...
    encounter errors which we may have failed to incorporate. We request you to raise an issue `here <https://github.com/hudson-and-thames/portfoliolab/issues>`_ and we will promptly push a fix for it.

Implementation
##############

.. automodule:: portfoliolab.modern_portfolio_theory.mean_variance
...
.. image:: modern_portfolio_theory_images/efficient_frontier.png
