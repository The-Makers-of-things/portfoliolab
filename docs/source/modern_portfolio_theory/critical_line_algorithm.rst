.. _modern_portfolio_theory-critical_line_algorithm:
...
PortfolioLab's :py:mod:`CriticalLineAlgorithm` class provides the following solutions to be used out-of-the-box.
...
.. automodule:: portfoliolab.modern_portfolio_theory.cla
